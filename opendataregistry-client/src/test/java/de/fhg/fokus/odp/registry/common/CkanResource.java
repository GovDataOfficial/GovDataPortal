...
@Path("/")
public class CkanResource implements CKANClientAction, CKANClientUtil, CKANClientSearch, CKANClientModel
{
  ...
  @Override
  public JsonNode getLatestMetadata(String q, String sort, String start, String rows)
  {
    return this.node;
  }

  @Override
  public JsonNode searchDatasetsByGroup(String q, String all_fields)
  {
    return this.node;
  }
