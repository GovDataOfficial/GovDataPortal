...
@FacesValidator(value = "agsValidator")
public class AgsValidator implements Validator {

	private static final Logger log = LoggerFactory
			.getLogger(AgsValidator.class);
	...
	public void validate(FacesContext context, UIComponent component,
		...
		if (value != null && !((String) value).isEmpty()
			...
			FacesMessage msg = new FacesMessage(LanguageUtil.get(
					request.getLocale(), "od.ags.invalid.error"),
					LanguageUtil.get(request.getLocale(),
							"od.ags.invalid.error"));
